...
function sendEmail() {
   ...
   Email.send({
      SecureToken: "8ef4f1d1-9c10-4a97-a07b-c6197287cbb4",
      To : 'brian@happykiln.com',
      From : "brian@happykiln.com",
...
form.addEventListener("submit", (e) => {
   ...
   contains("error") && !phone.classList.contains("error") && !subject.classList.
